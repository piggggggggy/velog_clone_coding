            ...
            <LeftContent>
              <section>
                ...
                <div>
                  ...
                  <TextPreview>
                    <h4></h4>
                    <textarea onChange={changeIntro} placeholder="당신의 포스트를 짧게 소개해보세요."></textarea>
                    <div>0/150</div>
                  </TextPreview>
                </div>
              </section>
            ...
            <RightContent>
              <RightBody>
                <section style={{outline: "none", border: "none"}}>
                  <h3>공개 설정</h3>
                  <OpenSetting>
                    <button style={{border: "1px solid #20c997", color: "#20c997"}}>
              ...
              <RightFooter>
                <button onClick={offModal} sytle={{backgroundColor: "#868e96"}}>취소</button>
...
{/* ------------------------------------------------------------------- */}
      ...
      <PostContainer>
        <WriteHeadrContainer>
          ...
          <UnderLine></UnderLine>
          <TagContainer>
            <Input onChange={changeTag} type="text" placeholder="태그를 입력하세요"></Input>
          </TagContainer>
        </WriteHeadrContainer>
        <Editor
          ref={editorRef}
